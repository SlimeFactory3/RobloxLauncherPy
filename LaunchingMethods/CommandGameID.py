...
GameID='id'#change with id 

RobloxArgs=f"--play -a https://auth.roblox.com/v1/authentication-ticket/redeem -t {Ticket} -j \"https://assetgame.roblox.com/game/PlaceLauncher.ashx?request=RequestGame&placeId={PlaceID}&gameId={GameID}&isPlayTogetherGame=false\""
#print(RobloxArgs)
